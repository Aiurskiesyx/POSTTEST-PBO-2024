...
public class Main {
        ...
        static ArrayList<Anak> Ank = new ArrayList<>();
        static ArrayList<Dewasa> Dws = new ArrayList<>();
        public static ArrayList<Hijab> dataHijab = new ArrayList<>();
    ...
    // Method Tambah dengan parameter jenis untuk menambah hijab anak atau dewasa
    public static void Tambah(String jenis) throws IOException {
        if ("Anak".equals(jenis)) {
            System.out.println("Masukkan Merk Hijab :");
            String merk = br.readLine();
            System.out.println("Masukkan Jenis Hijab:");
            String jenisHijab = br.readLine();
            ...
            Anak dataAnak = new Anak(merk, warna, jenisHijab, stok, harga, ukuran);
            Ank.add(dataAnak);
            ...
            Dewasa dataDewasa = new Dewasa(merk, warna, jenisHijab, stok, harga, bahan);
            Dws.add(dataDewasa);
        }
    }
