...
public final class Main {
    ...
    public static void main(String[] args) throws IOException {
       // Inisialisasi login handler
       Login loginHandler = new LoginHandler(br);

       // Menampilkan pesan login prompt dengan input username dan password
       loginHandler.displayLoginPrompt();
        while (true) {
            System.out.println("""
